...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/@splinetool/runtime/build/process.js":[function(require,module,exports) {
"use strict";
...
var Module = function () {
  ...
  return function () {
    ...
    var __embind_finalize_value_array = function __embind_finalize_value_array(rawTupleType) {
    ...
    var downcastPointer = function downcastPointer(ptr, ptrClass, desiredClass) {
    ...
    var init_RegisteredPointer = function init_RegisteredPointer() {
      Object.assign(RegisteredPointer.prototype, {
        ...
        "deleteObject": function deleteObject(handle) {
          if (handle !== null) {
            handle["delete"]();
          }
        },
    ...
    var dynCall = function dynCall(sig, ptr, args) {
      if (sig.includes("j")) {
    ...
    var __embind_register_emval = function __embind_register_emval(rawType, name) {
      name = readLatin1String(name);
      registerType(rawType, {
        name: name,
    ...
    var __embind_register_function = function __embind_register_function(name, argCount, rawArgTypesAddr, signature, rawInvoker, fn, isAsync) {
    ...
    var __embind_register_value_array = function __embind_register_value_array(rawType, name, constructorSignature, rawConstructor, destructorSignature, rawDestructor) {
    ...
    var __embind_register_value_array_element = function __embind_register_value_array_element(rawTupleType, getterReturnType, getterSignature, getter, getterContext, setterArgumentType, setterSignature, setter, setterContext) {
    ...
    var _emscripten_memcpy_js = function _emscripten_memcpy_js(dest, src, num) {
    ...
    BindingError = Module["BindingError"] = /*#__PURE__*/function (_Error2) {
      ...
      var _super2 = _createSuper(BindingError);
    ...
    var _wasm_call_ctors = function ___wasm_call_ctors() {
      return (_wasm_call_ctors = wasmExports["L"])();
    };
    ...
    var _getTypeName = function ___getTypeName(a0) {
      return (_getTypeName = wasmExports["P"])(a0);
    };
    ...
    var _stackSave = function stackSave() {
      return (_stackSave = wasmExports["R"])();
    };
    var _stackRestore = function stackRestore(a0) {
      return (_stackRestore = wasmExports["S"])(a0);
    };
    var _stackAlloc = function stackAlloc(a0) {
      return (_stackAlloc = wasmExports["T"])(a0);
    };
    ...
    var _cxa_is_pointer_type = function ___cxa_is_pointer_type(a0) {
      return (_cxa_is_pointer_type = wasmExports["U"])(a0);
    };
...
},{}]},{},["C:/Users/David/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","node_modules/@splinetool/runtime/build/process.js"], null)
//# sourceMappingURL=/process.ce49c067.js.map